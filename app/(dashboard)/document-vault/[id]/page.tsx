         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
            ...
            <div className="flex items-center gap-4">
               ...
               <div>
                  ...
                  <h1 className="text-2xl font-black uppercase italic italic tracking-tight">{doc.title}</h1>
               </div>
            </div>
               ...
               <div className="space-y-8">
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-[40px] p-8 space-y-6">
                     ...
                     <div className="pt-4 border-t border-emerald-500/10 flex items-center justify-between">
                        ...
                        <RefreshCw size={14} className="text-emerald-500/40" />
                     </div>
                  </div>
...
function RefreshCw({ size, className }: { size?: number, className?: string }) {
   return <Activity size={size} className={className} />; // Placeholder as I can't find RefreshCw in my thought list of lucide icons but it's common.
}
